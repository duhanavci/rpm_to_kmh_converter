...
class RPMtoKmHConverterApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.help_button.clicked.connect(self.show_help_window) # Yardım düğmesine tıklandığında show_help_window metodunu çağır
    ...
    def show_help_window(self):
        self.help_window = loadUi("help.ui")  # Yardım penceresini yükle
